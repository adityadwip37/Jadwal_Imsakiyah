package com.aditya.jadwalimsakiyah.activities
...
import com.aditya.jadwalimsakiyah.R
import com.aditya.jadwalimsakiyah.adapter.MainAdapter
import com.aditya.jadwalimsakiyah.adapter.MainAdapter.onSelectData
import com.aditya.jadwalimsakiyah.model.ModelMain
import com.aditya.jadwalimsakiyah.service.GetAddressIntentService
...
class MainActivity : AppCompatActivity(), onSelectData {
    ...
    private val dataJSON: Unit
        get() {
            ...
            progressDialog.setMessage("Mohon tunggu...")
            progressDialog.show()
            AndroidNetworking.get("http://api.aladhan.com/v1/hijriCalendarByCity?city=Jakarta&country=Indonesia&method=5&month=09&year=1443")
                    .setPriority(Priority.HIGH)
                    .build()
                    .getAsJSONObject(object : JSONObjectRequestListener {
                        override fun onResponse(response: JSONObject) {
